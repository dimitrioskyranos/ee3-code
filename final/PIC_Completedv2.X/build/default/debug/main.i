...
# 46 "main.c"
   ...
   static _Bool neutrals_sampled = 0;
...
# 392 "main.c"
    ...
    if (time_to_sample) {
        time_to_sample = 0;
         ...
         if (!neutrals_sampled && !sample_neutrals_busy && !sample_neutrals_done) {
            sample_neutral_values(sample_byte);
            sample_neutrals_busy = 1;
        }

        else if (sample_neutrals_done && !sample_cycle_busy && !sample_cycle_done) {
