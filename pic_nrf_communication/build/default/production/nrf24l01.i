...
# 1 "C:\\Users\\dimk2\\Desktop\\EE3\\pic_nrf_communication\\nrf24l01.h" 1
# 15 "C:\\Users\\dimk2\\Desktop\\EE3\\pic_nrf_communication\\nrf24l01.h"
...
# 16 "C:\\Users\\dimk2\\Desktop\\EE3\\pic_nrf_communication\\nrf24l01.h" 2
# 51 "C:\\Users\\dimk2\\Desktop\\EE3\\pic_nrf_communication\\nrf24l01.h"
# 1 "./SPILibrary16F886.h" 1
...
void SPIOff();
# 51 "C:\\Users\\dimk2\\Desktop\\EE3\\pic_nrf_communication\\nrf24l01.h" 2
# 359 "C:\\Users\\dimk2\\Desktop\\EE3\\pic_nrf_communication\\nrf24l01.h"
...
void nrf24l01_initialize_debug(_Bool rx, unsigned char p0_payload_width, _Bool enable_auto_ack);
void nrf24l01_initialize_debug_lite(_Bool rx, unsigned char p0_payload_width);


void nrf24l01_power_up(_Bool rx_active_mode);
void nrf24l01_power_up_param(_Bool rx_active_mode, unsigned char config);
...
uint8_t nrf24l01_write_tx_payload(unsigned char * data, unsigned int len);
...
void nrf24l01_set_as_rx(_Bool rx_active_mode);
void nrf24l01_set_as_rx_param(_Bool rx_active_mode, unsigned char config);
...
_Bool nrf24l01_aa_enabled(unsigned char rxpipenum);
void nrf24l01_aa_enable(unsigned char rxpipenum);
void nrf24l01_aa_disable(unsigned char rxpipenum);
_Bool nrf24l01_rx_pipe_enabled(unsigned char rxpipenum);
...
_Bool nrf24l01_irq_pin_active(void);
_Bool nrf24l01_irq_rx_dr_active(void);
_Bool nrf24l01_irq_tx_ds_active(void);
_Bool nrf24l01_irq_max_rt_active(void);
...
_Bool nrf24l01_fifo_tx_reuse(void);
_Bool nrf24l01_fifo_tx_full(void);
_Bool nrf24l01_fifo_tx_empty(void);
_Bool nrf24l01_fifo_rx_full(void);
_Bool nrf24l01_fifo_rx_empty(void);
...
_Bool nrf24l01_ce_pin_active(void);
_Bool nrf24l01_csn_pin_active(void);


unsigned char nrf24l01_execute_command(unsigned char instruction, unsigned char * data, unsigned int len, _Bool copydata);
void nrf24l01_spi_send_read(unsigned char * data, unsigned int len, _Bool copydata);
       ...
       unsigned char rx_pw_p5)
{
 ...
 data[0] = en_aa;
 nrf24l01_write_register(0x01, data, 1);

 data[0] = en_rxaddr;
 nrf24l01_write_register(0x02, data, 1);

 data[0] = setup_aw;
 nrf24l01_write_register(0x03, data, 1);

 data[0] = setup_retr;
 nrf24l01_write_register(0x04, data, 1);

 data[0] = rf_ch;
 nrf24l01_write_register(0x05, data, 1);

 data[0] = rf_setup;
 nrf24l01_write_register(0x06, data, 1);

 if(rx_addr_p0 != ((void*)0))
 ...
 data[0] = rx_pw_p0;
 nrf24l01_write_register(0x11, data, 1);

 data[0] = rx_pw_p1;
 nrf24l01_write_register(0x12, data, 1);

 data[0] = rx_pw_p2;
 nrf24l01_write_register(0x13, data, 1);

 data[0] = rx_pw_p3;
 nrf24l01_write_register(0x14, data, 1);

 data[0] = rx_pw_p4;
 nrf24l01_write_register(0x15, data, 1);

 data[0] = rx_pw_p5;
 nrf24l01_write_register(0x16, data, 1);
...
void nrf24l01_initialize_debug_lite(_Bool rx, unsigned char p0_payload_width)
{
 ...
 nrf24l01_write_register(0x11, &p0_payload_width, 1);
 nrf24l01_power_up_param(1, config);
}
# 222 "nrf24l01.c"
void nrf24l01_power_up(_Bool rx_active_mode)
{
 ...
 nrf24l01_read_register(0x00, &config, 1);
 ...
 nrf24l01_write_register(0x00, &config, 1);
...
void nrf24l01_set_as_tx_param(unsigned char config)
{
 ...
 if((config & 0x02) != 0)
  nrf24l01_power_up_param(0, config);
 else
  nrf24l01_power_down_param(config);
}
# 410 "nrf24l01.c"
unsigned char nrf24l01_write_register(unsigned char regnumber, unsigned char * data, unsigned int len)
{
 return nrf24l01_execute_command(0x20 | (regnumber & 0x1F), data, len, 0);
}
# 424 "nrf24l01.c"
unsigned char nrf24l01_read_register(unsigned char regnumber, unsigned char * data, unsigned int len)
{
 return nrf24l01_execute_command(regnumber & 0x1F, data, len, 1);
}
# 436 "nrf24l01.c"
unsigned char nrf24l01_write_tx_payload(unsigned char * data, unsigned int len)
{
 ...
 status = nrf24l01_execute_command(0xA0, data, len, 0);
...
unsigned char nrf24l01_read_rx_payload(unsigned char * data, unsigned int len)
{
 ...
 nrf24l01_clear_ce();
 status = nrf24l01_execute_command(0x61, data, len, 1);
 nrf24l01_set_ce();
...
{
 return nrf24l01_execute_command(0xE1, ((void*)0), 0, 1);
}
...
{
 return nrf24l01_execute_command(0xE2, ((void*)0), 0, 1);
}
...
{
 return nrf24l01_execute_command(0xE3, ((void*)0), 0, 1);
}
...
{
 return nrf24l01_execute_command(0xFF, ((void*)0), 0, 1);
}
...
{
 nrf24l01_set_ce();
 _delay((unsigned long)((11)*(64000000U/4000000.0)));
 nrf24l01_clear_ce();
}
...
void nrf24l01_set_tx_addr(unsigned char * address, unsigned int len)
{
 nrf24l01_write_register(0x10, address, len);
}
# 566 "nrf24l01.c"
void nrf24l01_set_rx_addr(unsigned char * address, unsigned int len, unsigned char rxpipenum)
{
 ...
 nrf24l01_write_register(0x0A + rxpipenum, address, len);
}
# 581 "nrf24l01.c"
void nrf24l01_set_rx_pw(unsigned char payloadwidth, unsigned char rxpipenum)
{
 ...
 nrf24l01_write_register(0x11 + rxpipenum, &payloadwidth, 1);
}
...
unsigned char nrf24l01_get_rx_pw(unsigned char rxpipenum)
{
 ...
 nrf24l01_read_register(0x11 + rxpipenum, &data, 1);
...
unsigned char nrf24l01_get_rf_ch()
{
 ...
 nrf24l01_read_register(0x05, &data, 1);
...
unsigned char nrf24l01_get_observe_tx()
{
 ...
 nrf24l01_read_register(0x08, &data, 1);
...
void nrf24l01_clear_plos_cnt_param(unsigned char rf_ch)
{
 nrf24l01_write_register(0x05, &rf_ch, 1);
}
...
_Bool nrf24l01_rx_pipe_enabled(unsigned char rxpipenum)
{
 ...
 nrf24l01_read_register(0x02, &data, 1);
...
_Bool nrf24l01_cd_active()
{
 unsigned char data;

 nrf24l01_read_register(0x09, &data, 1);
...
unsigned char nrf24l01_get_fifo_status()
{
 ...
 nrf24l01_read_register(0x17, &data, 1);
...
_Bool nrf24l01_fifo_tx_reuse()
{
 unsigned char data;

 nrf24l01_read_register(0x17, &data, 1);

 return (_Bool)(data & 0x40);
}


_Bool nrf24l01_fifo_tx_full()
{
 unsigned char data;

 nrf24l01_read_register(0x17, &data, 1);

 return (_Bool)(data & 0x20);
}


_Bool nrf24l01_fifo_tx_empty()
{
 unsigned char data;

 nrf24l01_read_register(0x17, &data, 1);

 return (_Bool)(data & 0x10);
}


_Bool nrf24l01_fifo_rx_full()
{
 unsigned char data;

 nrf24l01_read_register(0x17, &data, 1);

 return (_Bool)(data & 0x02);
}


_Bool nrf24l01_fifo_rx_empty()
{
 unsigned char data;

 nrf24l01_read_register(0x17, &data, 1);

 return (_Bool)(data & 0x01);
}


_Bool nrf24l01_irq_pin_active()
{
 if(RB0 != 0)
  return 0;
 else
...
_Bool nrf24l01_irq_rx_dr_active()
{
 return (nrf24l01_get_status() & 0x40);
}




_Bool nrf24l01_irq_tx_ds_active()
{
 return (nrf24l01_get_status() & 0x20);
}


_Bool nrf24l01_irq_max_rt_active()
{
 return (nrf24l01_get_status() & 0x10);
}


void nrf24l01_irq_clear_all()
{
 unsigned char data = 0x40 | 0x20 | 0x10;

 nrf24l01_write_register(0x07, &data, 1);
}
...
unsigned char nrf24l01_execute_command(unsigned char instruction, unsigned char * data, unsigned int len, _Bool copydata)
{
 ...
 status = instruction;
 nrf24l01_spi_send_read(&status, 1, 1);
...
void nrf24l01_spi_send_read(unsigned char * data, unsigned int len, _Bool copydata)
{
 ...
 {
  if(copydata != 0)
   data[count] = writeSPIByte(data[count]);
  else
  {
   tempbyte = data[count];
   writeSPIByte(tempbyte);
  }
 }
}
