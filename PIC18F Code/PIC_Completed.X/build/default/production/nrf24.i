...
# 1 "./mcc_generated_files/system/../clkref/clkref.h" 1
# 59 "./mcc_generated_files/system/../clkref/clkref.h"
...
# 118 "./mcc_generated_files/system/../adc/adc.h"
...
# 210 "./mcc_generated_files/system/../adc/adc.h"
...
# 267 "./mcc_generated_files/system/../adc/adc.h"
_Bool ADC_IsAccumulatorClearComplete(void);
# 276 "./mcc_generated_files/system/../adc/adc.h"
_Bool ADC_HasAccumulatorOverflowed(void);
# 285 "./mcc_generated_files/system/../adc/adc.h"
...
# 358 "./mcc_generated_files/system/../adc/adc.h"
...
# 415 "./mcc_generated_files/system/../adc/adc.h"
...
# 432 "./mcc_generated_files/system/../adc/adc.h"
...
# 465 "./mcc_generated_files/system/../adc/adc.h"
_Bool ADC_IsConversionDoneInterruptFlagSet(void);
# 474 "./mcc_generated_files/system/../adc/adc.h"
...
volatile _Bool time_to_sample = 0;
# 49 "./mcc_generated_files/system/system.h" 2

# 1 "./mcc_generated_files/system/../../nrf24.h" 1
# 56 "./mcc_generated_files/system/../../nrf24.h"
...
uint8_t nrf24_readReg(uint8_t reg)
{
    ...
    data_read = SPI1_ByteExchange(0xFF);
    CS_unselect();
...
void init_NRF(void)
{
 ...
 nrf24_writeReg(0x00, 0);
    uint8_t t = nrf24_readReg(0x05);
    t = t + 1;
 nrf24_writeReg(0x01, 0);
    t = nrf24_readReg(0x00);
 nrf24_writeReg(0x02, 0);

 nrf24_writeReg(0x03, 0x03);

 nrf24_writeReg(0x04, 0);

 nrf24_writeReg(0x05, 0);
...
void NRF_TxMode(uint8_t *Address, uint8_t channel)
{
 ...
 nrf24_writeReg(0x05, channel);

 nrf24_writeRegMulti(0x10, Address, 5);



 uint8_t config = nrf24_readReg(0x00);
    config = config | (1<<1);
 nrf24_writeReg(0x00, config);
    nrf24_readReg(0x05);
...
uint8_t nrf_send_data(uint8_t *data)
{
    ...
    uint8_t fifostatus = nrf24_readReg(0x17);
...
void nrf24_reset(uint8_t REG)
    {
        if (REG == 0x07)
        {
            nrf24_writeReg(0x07, 0x00);
        }

        else if (REG == 0x17)
        {
            nrf24_writeReg(0x17, 0x11);
        }

        else {
        nrf24_writeReg(0x00, 0x08);
        nrf24_writeReg(0x01, 0x3F);
        nrf24_writeReg(0x02, 0x03);
        nrf24_writeReg(0x03, 0x03);
        nrf24_writeReg(0x04, 0x03);
        nrf24_writeReg(0x05, 0x02);
        nrf24_writeReg(0x06, 0x0E);
        nrf24_writeReg(0x07, 0x00);
        nrf24_writeReg(0x08, 0x00);
        nrf24_writeReg(0x09, 0x00);
        uint8_t rx_addr_p0_def[5] = {0xE7, 0xE7, 0xE7, 0xE7, 0xE7};
        nrf24_writeRegMulti(0x0A, rx_addr_p0_def, 5);
        uint8_t rx_addr_p1_def[5] = {0xC2, 0xC2, 0xC2, 0xC2, 0xC2};
        nrf24_writeRegMulti(0x0B, rx_addr_p1_def, 5);
        nrf24_writeReg(0x0C, 0xC3);
        nrf24_writeReg(0x0D, 0xC4);
        nrf24_writeReg(0x0E, 0xC5);
        nrf24_writeReg(0x0F, 0xC6);
        uint8_t tx_addr_def[5] = {0xE7, 0xE7, 0xE7, 0xE7, 0xE7};
        nrf24_writeRegMulti(0x10, tx_addr_def, 5);
        nrf24_writeReg(0x11, 0);
        nrf24_writeReg(0x12, 0);
        nrf24_writeReg(0x13, 0);
        nrf24_writeReg(0x14, 0);
        nrf24_writeReg(0x15, 0);
        nrf24_writeReg(0x16, 0);
        nrf24_writeReg(0x17, 0x11);
        nrf24_writeReg(0x1C, 0);
        nrf24_writeReg(0x1D, 0);
     }
    }
